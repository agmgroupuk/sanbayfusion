...
const APPS = [
    {
        ...
        icon: Bot,
        color: 'violet',
        webUrl: 'https://sanbayfusion.com',
        pwaUrl: 'https://sanbayfusion.com',
        features: ['18 AI agents', 'Voice chat', 'Session memory', 'Push notifications'],
        platforms: {
            pwa: { available: true, label: 'Install PWA', url: 'https://sanbayfusion.com' },
    ...
    },
    {
        ...
        icon: Code2,
        color: 'red',
        webUrl: 'https://canvas.sanbayfusion.com',
        pwaUrl: 'https://canvas.sanbayfusion.com',
        features: ['9+ AI providers', 'Live preview', 'Deploy to 5 platforms', '40+ languages'],
        platforms: {
            pwa: { available: true, label: 'Install PWA', url: 'https://canvas.sanbayfusion.com' },
            playStore: { available: false, label: 'Google Play', url: '#' },
            appStore: { available: false, label: 'App Store', url: '#' },
            msStore: { available: false, label: 'Microsoft Store', url: '#' },
            macDmg: { available: false, label: 'macOS (.dmg)', url: '#' },
    ...
    },
    {
        ...
        icon: Palette,
        color: 'cyan',
        webUrl: 'https://studio.sanbayfusion.com',
        pwaUrl: 'https://studio.sanbayfusion.com',
        features: ['Monaco Editor', 'Sandpack runtime', 'Multi-file projects', 'AI code assist'],
        platforms: {
            pwa: { available: true, label: 'Install PWA', url: 'https://studio.sanbayfusion.com' },
            playStore: { available: false, label: 'Google Play', url: '#' },
            appStore: { available: false, label: 'App Store', url: '#' },
            msStore: { available: false, label: 'Microsoft Store', url: '#' },
            macDmg: { available: false, label: 'macOS (.dmg)', url: '#' },
    ...
    },
    {
        ...
        icon: Sparkles,
        color: 'amber',
        webUrl: 'https://demo.sanbayfusion.com',
        pwaUrl: 'https://demo.sanbayfusion.com',
        features: ['No sign-up needed', 'Live AI chat', 'Feature showcase', 'Interactive tour'],
        platforms: {
            pwa: { available: true, label: 'Install PWA', url: 'https://demo.sanbayfusion.com' },
            playStore: { available: false, label: 'Google Play', url: '#' },
            appStore: { available: false, label: 'App Store', url: '#' },
            msStore: { available: false, label: 'Microsoft Store', url: '#' },
            macDmg: { available: false, label: 'macOS (.dmg)', url: '#' },
