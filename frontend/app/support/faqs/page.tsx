  ...
  const faqs = [
    {
      ...
      questions: [
        { q: 'What is Maula AI?', a: 'Maula AI is a comprehensive AI platform with 20+ specialized AI agents, Canvas Studio for building full-stack web apps, and powerful creative tools for images, video, audio, and data. Access it through maula.ai and spaces.maula.ai (Canvas App, Canvas Studio, GenCraft Pro, and Maula Editor).' },
    ...
    },
    {
      ...
      questions: [
        { q: 'What apps are available?', a: 'We offer four applications: Canvas App (AI web-app builder), Canvas Studio (advanced AI builder with live preview and deployment), GenCraft Pro (full IDE with dual editors and terminal), and Maula Editor (professional IDE at spaces.maula.ai). Each is designed for different use cases and skill levels.' },
    ...
    },
    {
      ...
      questions: [
        ...
        { q: 'Do you offer refunds?', a: 'Yes. Please see our Payments & Refunds policy at maula.ai/legal/payments-refunds for full refund details, timelines, and how to submit a request. Contact support@maula.ai for refund inquiries.' },
    ...
    },
    {
      ...
      questions: [
        ...
        { q: 'Can I export my data?', a: 'Yes. You can request a full export of your personal data in JSON format by contacting privacy@maula.ai. This includes your account data, conversation history, agent memories, and project files. We will process your request within 30 days.' },
    ...
    },
    {
      ...
      questions: [
        ...
        { q: 'Do you sell my data?', a: 'No. We do NOT sell personal information. We do NOT share data for advertising. We do not use third-party tracking cookies, pixels, or ad networks. See our Privacy Policy at maula.ai/legal/privacy-policy for complete details.' },
        { q: 'What cookies does Maula AI use?', a: 'We use only 3 essential cookies for authentication (neural_link_session, neural_token, session_id) — all HTTP-only and secure. No marketing cookies, no analytics cookies, no third-party cookies. We also store some preferences in your browser\'s localStorage (theme, selected model). See our Cookie Policy at maula.ai/legal/cookie-policy.' },
        { q: 'Are you GDPR and CCPA compliant?', a: 'Yes. We comply with GDPR (EU/EEA/UK), CCPA/CPRA (California), and CalOPPA. You have the right to access, correct, export, and delete your data. You can exercise any of these rights by emailing privacy@maula.ai — we respond within 30-45 days as required by law.' },
        { q: 'What are my data rights?', a: 'You can: access and download your data, correct inaccurate information, request deletion of all your data, export data in JSON format, object to processing, and control AI agent memories. For GDPR requests: dpo@maula.ai. For CCPA requests: privacy@maula.ai.' },
