    ...
    const sections = [
        ...
        },
        {
            id: 'rights', icon: UserCheck, title: '5. Your Rights', glow: 'rgba(236,72,153,0.4)', content: [
                ...
                { subtitle: 'How to Exercise Your Rights', text: 'Email: privacy@sanbayfusion.com · In-app: Dashboard → Preferences → Privacy Controls · Mailing address: One Last AI, Attn: Privacy Team (see Contact section below). We verify your identity before processing any request. We respond within 30 days (GDPR) or 45 days (CCPA/CPRA), with extensions as permitted by law. We will not charge a fee for reasonable requests.' },
            ]
        },
        {
        ...
        },
        {
            id: 'ccpa', icon: FileText, title: '7. CCPA & CPRA Compliance (California)', glow: 'rgba(251,146,60,0.4)', content: [
                ...
                { subtitle: '7.3 Submitting a Verifiable Consumer Request', text: 'Email privacy@sanbayfusion.com with subject \u201cCCPA Request\u201d or use in-app Privacy Controls (Dashboard \u2192 Preferences). We verify identity by matching information against our records. Authorised agents require signed written authorisation or power of attorney. Response within 10 business days (acknowledgement) and 45 calendar days (substantive), extendable by 45 days with notice (90 total).' },
        ...
        },
        {
            id: 'caloppa', icon: MapPin, title: '8. CalOPPA Compliance', glow: 'rgba(168,85,247,0.4)', content: [
                { subtitle: '8.1 Privacy Policy Accessibility', text: 'Pursuant to the California Online Privacy Protection Act (Cal. Bus. & Prof. Code \u00a7\u00a7 22575\u201322579), this Privacy Policy is conspicuously posted via a \u201cPrivacy Policy\u201d link in the footer of every page on sanbayfusion.com, accessible from the registration page and account settings. The link uses the word \u201cPrivacy\u201d as required by \u00a7 22577(b)(1).' },
                ...
                { subtitle: '8.3 Review & Request Changes (\u00a7 22575(b)(2))', text: 'You may review, update, or request changes to your PII by logging into Dashboard \u2192 Profile or emailing privacy@sanbayfusion.com. We process requests within 30 days.' },
        ...
        },
        {
            id: 'security', icon: Lock, title: '10. Data Security', glow: 'rgba(16,185,129,0.4)', content: [
                ...
                { subtitle: 'Authentication & Access Controls', text: 'bcrypt password hashing (never stored in plaintext). HTTP-only secure JWT session cookies (HMAC-SHA256 signed). Role-based access control (RBAC) with principle of least privilege. CORS restricted to sanbayfusion.com and app domains. COOP/COEP headers for WebContainer SharedArrayBuffer isolation.' },
        ...
        },
        {
            id: 'international', icon: Server, title: '11. International Data Transfers', glow: 'rgba(99,102,241,0.4)', content: [
                ...
                { subtitle: 'EU/EEA Users', text: 'For users in the EU/EEA, we comply with GDPR Chapter V requirements. For business customers, we offer a Data Processing Agreement (DPA) upon request. Contact privacy@sanbayfusion.com to learn more about safeguards in place.' },
            ]
        },
        {
            id: 'pdpa-thailand', icon: Globe, title: '12. PDPA Thailand (พ.ร.บ.คุ้มครองข้อมูลส่วนบุคคล)', glow: 'rgba(251,191,36,0.4)', content: [
                ...
                { subtitle: '12.5 Data Protection Officer (Thailand)', text: 'For PDPA Thailand inquiries, contact our Data Protection Officer at dpo@sanbayfusion.com. You may also lodge complaints with the Personal Data Protection Committee (PDPC) of Thailand at pdpc.or.th.' },
            ]
        },
        {
        ...
        },
        {
            id: 'uae-data', icon: Globe, title: '14. UAE Data Protection (Federal Decree-Law No. 45/2021)', glow: 'rgba(34,197,94,0.4)', content: [
                ...
                { subtitle: '14.6 UAE Data Office', text: 'For UAE-specific data protection inquiries, contact dpo@sanbayfusion.com. You may also file complaints with the UAE Data Office (established under Federal Decree-Law No. 44 of 2021) at uaedataoffice.ae.' },
            ]
        },
        {
            id: 'children', icon: AlertTriangle, title: '15. Children\'s Privacy (COPPA)', glow: 'rgba(239,68,68,0.4)', content: [
                ...
                { subtitle: 'Parental Notice', text: 'If you are a parent or guardian and believe your child has provided us with personal information, please contact us immediately at privacy@sanbayfusion.com. We will delete such information within 48 hours of verification.' },
        ...
        <div ref={containerRef} className="min-h-screen bg-[#030304] text-white overflow-x-hidden">
            ...
            <section className="relative pt-28 pb-16 lg:pt-36 lg:pb-20 z-10">
                <div className="container mx-auto px-4 text-center relative z-10">
                    ...
                    <p className="hero-subtitle text-lg text-gray-400 max-w-2xl mx-auto mb-8 font-light" style={{ opacity: 0 }}>This policy covers <span className="text-cyan-400">sanbayfusion.com</span> and <span className="text-cyan-400">spaces.sanbayfusion.com</span> (Canvas App, Canvas Studio, GenCraft Pro, Maula Editor). We are committed to protecting your privacy in compliance with GDPR, CCPA/CPRA, CalOPPA, COPPA, PIPEDA, PDPA Thailand, PDPA Singapore, and UAE PDPL.</p>
            ...
            <section className="relative py-12 z-10">
                <div className="container mx-auto px-4"><div className="max-w-4xl mx-auto">
                    ...
                    <div className="contact-block mt-14 p-7 rounded-2xl bg-white/[0.02] border border-white/[0.06]">
                        ...
                        <p className="text-gray-600 text-xs mb-6">For GDPR data subject requests: <strong className="text-gray-400">dpo@sanbayfusion.com</strong> &middot; For CCPA/CPRA verifiable consumer requests: <strong className="text-gray-400">privacy@sanbayfusion.com</strong> &middot; Response within 30\u201345 days as required by applicable law.</p>
                        <div className="flex flex-wrap gap-3">
                            <Link href="mailto:privacy@sanbayfusion.com" className="px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-600/20 to-emerald-600/20 border border-cyan-500/25 text-cyan-400 font-medium text-sm hover:border-cyan-500/40 transition-all">privacy@sanbayfusion.com</Link>
