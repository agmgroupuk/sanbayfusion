    ...
    const sections = [
        ...
        },
        {
            id: 'localstorage', icon: Cog, title: '5. Local Storage & Client-Side Data', glow: 'rgba(16,185,129,0.4)', content: [
                ...
                { subtitle: 'How to Clear', text: 'Open your browser Developer Tools (F12) \u2192 Application tab \u2192 Local Storage. Select sanbayfusion.com or spaces.sanbayfusion.com and delete individual keys or clear all entries. Alternatively, use your browser\'s privacy/site data settings to clear all data for the domain. Clearing localStorage resets preferences to defaults but does NOT affect server-side account data (projects, chat history, agent memories, billing records remain safe in PostgreSQL and S3).' },
