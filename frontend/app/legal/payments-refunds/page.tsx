    ...
    const sections = [
        ...
        },
        {
            id: 'pricing', icon: CreditCard, title: '2. Pricing Structure', glow: 'rgba(59,130,246,0.4)', content: [
                { subtitle: 'Per-Agent Pricing', text: 'Sanbay Fusion operates on a per-agent access model. Each AI agent has individual pricing — there are no bundled subscription plans. Choose from four flexible durations: 1 Day ($1), 1 Week ($10→$5 — 50% OFF), 1 Month ($30→$15 — 50% OFF), or 1 Year ($300→$150 — 50% OFF) per agent. Each purchase is one-time only with NO auto-renewal. You must manually re-purchase when access expires.' },
                ...
                { subtitle: '2.2 No Free Tier', text: 'Sanbay Fusion does not offer a free tier. All agent access requires a one-time payment starting at $1/day. This low-cost model ensures high-quality AI services without ads, continuous platform improvements, responsive customer support, data privacy and security investments, and no surprise recurring charges.' },
