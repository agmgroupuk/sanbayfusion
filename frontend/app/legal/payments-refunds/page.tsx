    ...
    const sections = [
        ...
        },
        {
            id: 'no-refund', icon: Ban, title: '5. Refund Policy', glow: 'rgba(239,68,68,0.4)', content: [
                ...
                { subtitle: '5.5 Alternatives to Refunds', text: 'If you are experiencing issues that do not qualify for a refund: Contact Support at support@maula.ai for technical assistance. Cancel Your Access to prevent duplicate purchases. Provide Feedback to help us improve. Review Documentation and explore guides at maula.ai/docs.' },
            ]
        },
        {
            id: 'cancellation', icon: XCircle, title: '6. Cancellation & Access Management', glow: 'rgba(236,72,153,0.4)', content: [
                ...
                { subtitle: '6.1 Stopping Access Early', text: 'If you want to stop using an agent before your access expires: Method 1 — Agent Page: Go to the /subscribe page, find your active agent, click "Cancel Subscription", and confirm. Method 2 — Email: Send an email to support@maula.ai with your account email, agent name, and "CANCEL ACCESS" in the subject line.' },
        ...
        },
        {
            id: 'chargebacks', icon: AlertTriangle, title: '7. Chargebacks & Disputes', glow: 'rgba(245,158,11,0.4)', content: [
                { subtitle: '7.1 Contact Us First', text: 'Before filing a chargeback or payment dispute with your bank, please contact us at billing@maula.ai. We are committed to resolving billing issues quickly.' },
        ...
        <div ref={containerRef} className="min-h-screen bg-[#030304] text-white overflow-x-hidden">
            ...
            <section className="relative py-8 z-10">
                <div className="container mx-auto px-4"><div className="max-w-4xl mx-auto">
                    {/* ── Agent Pricing ── */}
                    <div className="mb-6">
                        <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-widest mb-4 flex items-center gap-2"><DollarSign className="w-4 h-4 text-emerald-400" />Per-Agent Access (maula.ai)</h3>
                    ...
                    {/* ── Platform Products ── */}
                    <div className="mb-12">
                        <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-widest mb-4 flex items-center gap-2"><Code className="w-4 h-4 text-violet-400" />Platform Products (spaces.maula.ai)</h3>
                    ...
                    <div className="contact-block mt-14 p-7 rounded-2xl bg-white/[0.02] border border-white/[0.06]">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <Link href="mailto:billing@maula.ai" className="px-6 py-3 rounded-xl bg-gradient-to-r from-emerald-600/20 to-cyan-600/20 border border-emerald-500/25 text-emerald-400 font-medium text-sm hover:border-emerald-500/40 transition-all">billing@maula.ai</Link>
                            <Link href="mailto:support@maula.ai" className="px-6 py-3 rounded-xl bg-white/[0.03] border border-white/[0.08] text-gray-400 font-medium text-sm hover:bg-white/[0.06] hover:text-white transition-all">support@maula.ai</Link>
                        </div>
                    </div>
                </div></div>
            </section>
