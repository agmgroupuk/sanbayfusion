  ...
  const sections = [
    {
      id: 'acceptance', icon: CheckCircle, title: 'Acceptance of Terms', glow: 'rgba(139,92,246,0.4)', content: [
        { subtitle: 'Agreement to Terms', text: 'By accessing or using any Maula AI service — including sanbayfusion.com, spaces.sanbayfusion.com, Canvas App, Canvas Studio, GenCraft Pro, and Maula Editor — you agree to be bound by these Terms of Service. If you disagree with any part, you may not access our services.' },
    ...
    },
    {
      id: 'user-accounts', icon: Users, title: 'User Accounts & Responsibilities', glow: 'rgba(16,185,129,0.4)', content: [
        { subtitle: 'Account Creation', text: 'You must provide accurate, complete information when creating an account. You are responsible for maintaining the confidentiality of your login credentials. Your account works across sanbayfusion.com and spaces.sanbayfusion.com via your Maula AI User ID.' },
    ...
    },
    {
      id: 'intellectual-property', icon: FileText, title: 'Intellectual Property', glow: 'rgba(249,115,22,0.4)', content: [
        { subtitle: 'Platform Ownership', text: 'Maula AI, including all software, content, features, and trademarks across sanbayfusion.com and spaces.sanbayfusion.com, is owned by us or our licensors and protected by intellectual property laws.' },
