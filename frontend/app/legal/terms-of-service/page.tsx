  ...
  const sections = [
    {
      id: 'acceptance', icon: CheckCircle, title: 'Acceptance of Terms', glow: 'rgba(139,92,246,0.4)', content: [
        { subtitle: 'Agreement to Terms', text: 'By accessing or using any Sanbay Fusion service — including sanbayfusion.com, spaces.sanbayfusion.com, Canvas App, Canvas Studio, GenCraft Pro, and Maula Editor — you agree to be bound by these Terms of Service. If you disagree with any part, you may not access our services.' },
        { subtitle: 'Eligibility', text: 'You must be at least 18 years old to use our services. By using Sanbay Fusion, you represent that you meet this age requirement and have the legal capacity to enter into a binding agreement.' },
        ...
        { subtitle: 'Additional Terms', text: 'Certain features (e.g., Maula Editor at spaces.sanbayfusion.com, Canvas Studio deployments, agent subscriptions) may be subject to additional terms or guidelines. Such additional terms are incorporated by reference into these Terms of Service.' },
      ]
    },
    {
      id: 'services', icon: Scale, title: 'Service Description', glow: 'rgba(6,182,212,0.4)', content: [
        { subtitle: 'Platform Overview', text: 'Sanbay Fusion operates sanbayfusion.com and spaces.sanbayfusion.com, providing four applications: Canvas App (AI web-app builder, 20 panels, CodeMirror 6), Canvas Studio (AI builder with Sandpack and CloudPreview via isolated sandbox infrastructure), GenCraft Pro (full IDE with dual editors, Monaco + CodeMirror 6, xterm.js terminal), and Maula Editor (professional IDE with NestJS server, 54 components, 50 services). The shared backend offers 268 AI tools across 39 categories.' },
    ...
    },
    {
      id: 'user-accounts', icon: Users, title: 'User Accounts & Responsibilities', glow: 'rgba(16,185,129,0.4)', content: [
        ...
        { subtitle: 'Credential Storage', text: 'You may store third-party deploy tokens (GitHub, Vercel, Netlify, the hosting provider) and API keys in our platform. These are encrypted with AES-256-GCM at the application level — never stored in plaintext, never logged, never included in AI prompts, and accessible only to the owning user. You are solely responsible for any actions taken using your stored credentials.' },
    ...
    },
    {
      id: 'intellectual-property', icon: FileText, title: 'Intellectual Property', glow: 'rgba(249,115,22,0.4)', content: [
        { subtitle: 'Platform Ownership', text: 'Sanbay Fusion, including all software, content, features, and trademarks across sanbayfusion.com and spaces.sanbayfusion.com, is owned by us or our licensors and protected by intellectual property laws.' },
    ...
    },
    {
      id: 'liability', icon: Shield, title: 'Limitation of Liability', glow: 'rgba(59,130,246,0.4)', content: [
        ...
        { subtitle: 'Limitation of Damages', text: 'To the maximum extent permitted by law, we shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of sanbayfusion.com, spaces.sanbayfusion.com, or any deployed application.' },
    ...
    },
    {
      id: 'device-security-service', icon: Gavel, title: 'Device Security Service', glow: 'rgba(239,68,68,0.4)', content: [
        ...
        { subtitle: 'Report Fee & Payment', text: 'After a sufficient period of data collection, our security team will compile a Location & Photo Report containing your device\'s tracked locations and captured images. Access to this report requires a one-time fee of $9.99 USD (subject to change with notice), payable via the payment provider. Upon successful payment, you receive a single-use secure download link valid for 48 hours. Payment is non-refundable once the download link is delivered.' },
        ...
        { subtitle: 'Limitation of Liability for Security Service', text: 'Sanbay Fusion does not guarantee that the Security Module will locate or recover your device, or that photographs will capture the thief\'s face or usable evidence. Device tracking depends on: the device remaining powered on and connected to data, Android killing the background service, and other environmental factors outside our control. THE SECURITY SERVICE IS PROVIDED "AS IS" WITHOUT WARRANTIES OF RECOVERY OR ACCURACY.' },
        { subtitle: 'Removal & Uninstall', text: 'You may deactivate and uninstall the Security Module at any time by revoking its Device Administrator privileges (Settings → Security → Device Admin Apps → Maula Security → Deactivate) and then uninstalling the app through Settings → Apps. You may also trigger a remote self-destruct via your account dashboard at sanbayfusion.com/dashboard/security.' },
      ]
    },
    {
      id: 'disputes', icon: Gavel, title: 'Dispute Resolution', glow: 'rgba(99,102,241,0.4)', content: [
        ...
        { subtitle: 'Informal Resolution', text: 'Before filing any legal claim, you agree to attempt to resolve disputes informally by contacting us at legal@sanbayfusion.com. We will make good-faith efforts to resolve disputes within 30 days.' },
    ...
    <div ref={containerRef} className="min-h-screen bg-[#030304] text-white overflow-x-hidden">
      ...
      <section className="relative pt-28 pb-16 lg:pt-36 lg:pb-20 z-10">
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="hero-subtitle text-lg text-gray-400 max-w-2xl mx-auto mb-8 font-light" style={{ opacity: 0 }}>These terms govern your use of <span className="text-violet-400">sanbayfusion.com</span> and <span className="text-violet-400">spaces.sanbayfusion.com</span> (Canvas App, Canvas Studio, GenCraft Pro, Maula Editor). <strong className="text-violet-300">We never sell your data and never use it to train AI models.</strong> Compliant with GDPR, CCPA/CPRA, PDPA Thailand, PDPA Singapore, and UAE PDPL.</p>
        ...
        <div className="container mx-auto px-4"><div className="max-w-4xl mx-auto">
          <div className="notice-block mb-10 p-5 rounded-2xl bg-white/[0.02] border border-amber-500/15 overflow-hidden">
            <div className="flex items-start gap-4">
              ...
              <div><h3 className="text-base font-bold text-gray-200 mb-1">Important Notice</h3><p className="text-gray-600 text-[13px] leading-relaxed">By using sanbayfusion.com or spaces.sanbayfusion.com, you agree to these Terms of Service. These terms cover Canvas App, Canvas Studio, GenCraft Pro, and Maula Editor. We use our own API keys to access all AI providers (Anthropic, OpenAI, Google, Mistral, xAI, Groq, Cerebras, HuggingFace) — your identity is never shared with them. We never sell your data and never use it for AI training. We comply with GDPR, CCPA/CPRA, PDPA Thailand, PDPA Singapore, and UAE PDPL. These terms include a mandatory arbitration clause and class action waiver. Please review the Dispute Resolution section carefully.</p></div>
            </div>
          </div>
          ...
          <div className="contact-block mt-14 p-7 rounded-2xl bg-white/[0.02] border border-white/[0.06]">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="mailto:legal@sanbayfusion.com" className="px-6 py-3 rounded-xl bg-gradient-to-r from-violet-600/20 to-pink-600/20 border border-violet-500/25 text-violet-400 font-medium text-sm hover:border-violet-500/40 transition-all">legal@sanbayfusion.com</Link>
