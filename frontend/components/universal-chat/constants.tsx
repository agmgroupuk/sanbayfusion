...
/**
 * PROVIDER_CONFIG - Display only; backend decides actual provider per agent
 * All calls go through secure backend which resolves provider from agentId
 */
...
export const DEFAULT_SETTINGS: SettingsState = {
  ...
  canvas: {
    content: "// Welcome to the workspace!\n\nStart typing or ask the AI to generate content.",
    type: 'text',
    title: 'Workspace'
  }
};
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Canvas App', icon: '💻', tool: 'canvas_app', description: 'Build apps with code' }
];
