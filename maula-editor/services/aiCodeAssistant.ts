...
const log = createLogger('aiCodeAssistant.ts');
/**
...
class AICodeAssistantService {
  ...
  private async callAPI(
    ...
    try {
      ...
      log.warn('[AICodeAssistant] Backend returned non-ok, falling back to direct API');
    } catch (err) {
      log.warn('[AICodeAssistant] Backend unreachable, falling back to direct API:', err);
    }
...
Provide a comprehensive code review.`;
    ...
    try {
      ...
      log.error('[AI Review] Error:', error);
      throw error;
    }
  }
...
Return the complete documentation that can be inserted before the code.`;
    ...
    try {
      ...
      log.error('[AI Documentation] Error:', error);
      throw error;
    }
  }
...
Return as JSON:
{
  ...
  "relatedTopics": ["..."]
    ...
    try {
      ...
      log.error('[AI Explanation] Error:', error);
      throw error;
    }
  }
...
Check for all security vulnerabilities including OWASP Top 10 and CWE common weaknesses.`;
    ...
    try {
      ...
      log.error('[AI Security] Error:', error);
      throw error;
    }
  }
...
Return the refactored code and explain the changes.`;
    ...
    try {
      ...
      log.error('[AI Refactor] Error:', error);
      throw error;
    }
  }
