      ...
      <div className={`flex-1 overflow-y-auto ${isOpen ? 'p-6 space-y-8' : 'p-2 space-y-4'}`}>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-2">
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 p-3 rounded-xl border transition-all ${isCodeMode
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-2">
            <button
              onClick={onSelectKey}
              className={`w-full flex items-center gap-3 p-3 rounded-xl border transition-all ${!hasKey
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 p-3 rounded-xl transition-all border ${isCameraActive
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                >
                  <option value={ModelType.FLASH}>Standard</option>
                  <option value={ModelType.PRO}>Advanced</option>
                </select>
              </div>
