...
const log = createLogger('UsageDashboard');
...
export const UsageDashboard: React.FC = () => {
  ...
  const API_BASE = import.meta.env.VITE_API_URL || (import.meta.env.PROD ? 'https://editor.sanbayfusion.com/api' : 'http://localhost:3200/api');
