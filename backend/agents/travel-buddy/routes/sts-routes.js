...
const ELEVENLABS_VOICES = {
  'travel-buddy': 'ErXwobaYiN019PkySvjV',  // Antoni - warm, adventurous, enthusiastic
};
...
const OPENAI_VOICES = {
  'travel-buddy': 'coral',  // Adventurous, warm
};

const AGENT_VOICE_CONFIG = {
  'travel-buddy': {
    gender: 'male',
    openaiVoice: OPENAI_VOICES['travel-buddy'],
    elevenlabsVoice: ELEVENLABS_VOICES['travel-buddy'],
    lmntVoice: LMNT_VOICES['travel-buddy'],
    personality: 'adventurous, enthusiastic, knowledgeable explorer'
  }
};
