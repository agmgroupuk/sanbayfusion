/**
 * Travel Buddy — Standalone Agent Backend
 * Port: 3427 | Provider: OpenAI gpt-4o | Fallbacks: mistral → xai
 */
...
const SLUG = 'travel-buddy';
const NAME = 'Travel Buddy';
const PROVIDER = 'openai';
const MODEL = 'gpt-4o';
const FALLBACKS = ['mistral', 'xai'];
const TEMPERATURE = 0.85;
const PORT = parseInt(process.env.PORT) || 3427;
...
app.use(cors({
  origin: process.env.CORS_ORIGIN?.split(',') || [
    'https://travel-buddy-chat.sanbayfusion.com',
