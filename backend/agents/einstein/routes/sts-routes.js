...
const ELEVENLABS_VOICES = {
  'einstein': 'onwK4e9ZLuTAKqWW03F9',  // Daniel - wise, authoritative, intellectual
};
...
const OPENAI_VOICES = {
  'einstein': 'echo',  // Wise, intellectual
};

const AGENT_VOICE_CONFIG = {
  'einstein': {
    gender: 'male',
    openaiVoice: OPENAI_VOICES['einstein'],
    elevenlabsVoice: ELEVENLABS_VOICES['einstein'],
    lmntVoice: LMNT_VOICES['einstein'],
    personality: 'wise, thoughtful, intellectual, curious genius'
  }
};
