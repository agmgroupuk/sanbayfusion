/**
 * Einstein — Standalone Agent Backend
 * Port: 3417 | Provider: OpenAI gpt-4o | Fallbacks: mistral → xai
 */
...
const PORT = parseInt(process.env.PORT) || 3417;
...
app.use(cors({
  origin: process.env.CORS_ORIGIN?.split(',') || [
    'https://einstein-chat.sanbayfusion.com',
