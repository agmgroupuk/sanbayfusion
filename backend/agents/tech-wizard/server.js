/**
 * Tech Wizard — Standalone Agent Backend
 * Port: 3426 | Provider: OpenAI gpt-4o | Fallbacks: mistral → xai
 */
...
const SLUG = 'tech-wizard';
const NAME = 'Tech Wizard';
const PROVIDER = 'openai';
const MODEL = 'gpt-4o';
const FALLBACKS = ['mistral', 'xai'];
const TEMPERATURE = 0.8;
const PORT = parseInt(process.env.PORT) || 3426;
...
app.use(cors({
  origin: process.env.CORS_ORIGIN?.split(',') || [
    'https://tech-wizard-chat.sanbayfusion.com',
