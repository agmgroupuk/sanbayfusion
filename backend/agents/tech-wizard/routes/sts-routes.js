...
const ELEVENLABS_VOICES = {
  'tech-wizard': 'N2lVS1w4EtoT3dr4eOWO',  // Callum - clear, helpful, knowledgeable
};
...
const OPENAI_VOICES = {
  'tech-wizard': 'echo',  // Clear, helpful
};

const AGENT_VOICE_CONFIG = {
  'tech-wizard': {
    gender: 'male',
    openaiVoice: OPENAI_VOICES['tech-wizard'],
    elevenlabsVoice: ELEVENLABS_VOICES['tech-wizard'],
    lmntVoice: LMNT_VOICES['tech-wizard'],
    personality: 'helpful, knowledgeable, patient tech expert'
  }
};
