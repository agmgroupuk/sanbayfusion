...
const ELEVENLABS_VOICES = {
  'bishop-burger': '2EiwWnXFnvU5JabPnv8n',  // Clyde - wise, spiritual, thoughtful
};
...
const OPENAI_VOICES = {
  'bishop-burger': 'sage',  // Wise, thoughtful
};

const AGENT_VOICE_CONFIG = {
  'bishop-burger': {
    gender: 'male',
    openaiVoice: OPENAI_VOICES['bishop-burger'],
    elevenlabsVoice: ELEVENLABS_VOICES['bishop-burger'],
    lmntVoice: LMNT_VOICES['bishop-burger'],
    personality: 'strategic, spiritual, wise diagonal thinker'
  }
};
