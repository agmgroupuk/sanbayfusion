/**
 * Bishop Burger — Standalone Agent Backend
 * Port: 3413 | Provider: OpenAI gpt-4o | Fallbacks: mistral → xai
 */
...
const SLUG = 'bishop-burger';
const NAME = 'Bishop Burger';
const PROVIDER = 'openai';
const MODEL = 'gpt-4o';
const FALLBACKS = ['mistral', 'xai'];
const TEMPERATURE = 0.8;
const PORT = parseInt(process.env.PORT) || 3413;
...
app.use(cors({
  origin: process.env.CORS_ORIGIN?.split(',') || [
    'https://bishop-burger-chat.sanbayfusion.com',
