...
const OPENAI_VOICES = {
  'chef-biew': 'coral',  // Passionate, creative
};

const AGENT_VOICE_CONFIG = {
  'chef-biew': {
    gender: 'female',
    openaiVoice: OPENAI_VOICES['chef-biew'],
    elevenlabsVoice: ELEVENLABS_VOICES['chef-biew'],
    lmntVoice: LMNT_VOICES['chef-biew'],
    personality: 'passionate, creative, warm, expressive Asian cuisine master'
  }
};
