/**
 * Fitness Guru — Standalone Agent Backend
 * Port: 3419 | Provider: OpenAI gpt-4o | Fallbacks: mistral → xai
 */
...
const SLUG = 'fitness-guru';
const NAME = 'Fitness Guru';
const PROVIDER = 'openai';
const MODEL = 'gpt-4o';
const FALLBACKS = ['mistral', 'xai'];
const TEMPERATURE = 0.75;
const PORT = parseInt(process.env.PORT) || 3419;
