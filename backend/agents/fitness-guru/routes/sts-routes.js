...
const ELEVENLABS_VOICES = {
  'fitness-guru': 'TxGEqnHWrfWFTfGW9XjX',  // Josh - deep, motivational, energetic
};
...
const OPENAI_VOICES = {
  'fitness-guru': 'ash',  // Energetic, motivational
};

const AGENT_VOICE_CONFIG = {
  'fitness-guru': {
    gender: 'male',
    openaiVoice: OPENAI_VOICES['fitness-guru'],
    elevenlabsVoice: ELEVENLABS_VOICES['fitness-guru'],
    lmntVoice: LMNT_VOICES['fitness-guru'],
    personality: 'motivational, energetic, encouraging fitness coach'
  }
};
