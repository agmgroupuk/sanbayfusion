/**
 * Ben Sega — Standalone Agent Backend
 * Port: 3412 | Provider: OpenAI gpt-4o | Fallbacks: mistral → xai
 */
...
const PORT = parseInt(process.env.PORT) || 3412;
...
app.use(cors({
  origin: process.env.CORS_ORIGIN?.split(',') || [
    'https://ben-sega-chat.sanbayfusion.com',
