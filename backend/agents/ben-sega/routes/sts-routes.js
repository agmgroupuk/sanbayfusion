...
const ELEVENLABS_VOICES = {
  'ben-sega': 'VR6AewLTigWG4xSOukaG',  // Arnold - crisp, nostalgic, playful
};
...
const OPENAI_VOICES = {
  'ben-sega': 'ballad',  // Nostalgic, playful
};

const AGENT_VOICE_CONFIG = {
  'ben-sega': {
    gender: 'male',
    openaiVoice: OPENAI_VOICES['ben-sega'],
    elevenlabsVoice: ELEVENLABS_VOICES['ben-sega'],
    lmntVoice: LMNT_VOICES['ben-sega'],
    personality: 'retro, nostalgic, playful gaming historian'
  }
};
