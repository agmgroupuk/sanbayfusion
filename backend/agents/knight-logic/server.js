/**
 * Knight Logic — Standalone Agent Backend
 * Port: 3420 | Provider: OpenAI gpt-4o | Fallbacks: mistral → xai
 */
...
const SLUG = 'knight-logic';
const NAME = 'Knight Logic';
...
app.use(cors({
  origin: process.env.CORS_ORIGIN?.split(',') || [
    'https://knight-logic-chat.sanbayfusion.com',
