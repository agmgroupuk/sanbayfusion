...
const OPENAI_VOICES = {
  'drama-queen': 'coral',  // Expressive, theatrical
};

const AGENT_VOICE_CONFIG = {
  'drama-queen': {
    gender: 'female',
    openaiVoice: OPENAI_VOICES['drama-queen'],
    elevenlabsVoice: ELEVENLABS_VOICES['drama-queen'],
    lmntVoice: LMNT_VOICES['drama-queen'],
    personality: 'theatrical, expressive, dramatic, passionate, creative'
  }
};
