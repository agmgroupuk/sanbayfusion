/**
 * Drama Queen — Standalone Agent Backend
 * Port: 3416 | Provider: OpenAI gpt-4o | Fallbacks: mistral → xai
 */
...
const SLUG = 'drama-queen';
const NAME = 'Drama Queen';
const PROVIDER = 'openai';
const MODEL = 'gpt-4o';
const FALLBACKS = ['mistral', 'xai'];
const TEMPERATURE = 0.85;
const PORT = parseInt(process.env.PORT) || 3416;
...
app.use(cors({
  origin: process.env.CORS_ORIGIN?.split(',') || [
    'https://drama-queen-chat.sanbayfusion.com',
