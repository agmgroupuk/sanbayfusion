/**
 * Nid Gaming — Standalone Agent Backend
 * Port: 3423 | Provider: OpenAI gpt-4o | Fallbacks: mistral → xai
 */
...
const SLUG = 'nid-gaming';
const NAME = 'Nid Gaming';
const PROVIDER = 'openai';
const MODEL = 'gpt-4o';
const FALLBACKS = ['mistral', 'xai'];
const TEMPERATURE = 0.85;
const PORT = parseInt(process.env.PORT) || 3423;
...
app.use(cors({
  origin: process.env.CORS_ORIGIN?.split(',') || [
    'https://nid-gaming-chat.sanbayfusion.com',
