...
const ELEVENLABS_VOICES = {
  'nid-gaming': 'MF3mGyEYCl7XYWbV9V6O',  // Elli - young, energetic, competitive
};
...
const OPENAI_VOICES = {
  'nid-gaming': 'ballad',  // Energetic, young
};

const AGENT_VOICE_CONFIG = {
  'nid-gaming': {
    gender: 'female',
    openaiVoice: OPENAI_VOICES['nid-gaming'],
    elevenlabsVoice: ELEVENLABS_VOICES['nid-gaming'],
    lmntVoice: LMNT_VOICES['nid-gaming'],
    personality: 'excited, energetic, competitive, fun pro gamer girl'
  }
};
