/**
 * Rook Jokey — Standalone Agent Backend
 * Port: 3425 | Provider: OpenAI gpt-4o | Fallbacks: mistral → xai
 */
...
const SLUG = 'rook-jokey';
const NAME = 'Rook Jokey';
const PROVIDER = 'openai';
const MODEL = 'gpt-4o';
const FALLBACKS = ['mistral', 'xai'];
const TEMPERATURE = 0.8;
const PORT = parseInt(process.env.PORT) || 3425;
