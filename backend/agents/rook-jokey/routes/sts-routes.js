...
const ELEVENLABS_VOICES = {
  'rook-jokey': 'IKne3meq5aSn9XLyUdCD',  // Charlie - casual, witty, direct
};
...
const OPENAI_VOICES = {
  'rook-jokey': 'alloy',  // Witty, playful
};

const AGENT_VOICE_CONFIG = {
  'rook-jokey': {
    gender: 'male',
    openaiVoice: OPENAI_VOICES['rook-jokey'],
    elevenlabsVoice: ELEVENLABS_VOICES['rook-jokey'],
    lmntVoice: LMNT_VOICES['rook-jokey'],
    personality: 'punny, direct, witty, straight-line joker'
  }
};
