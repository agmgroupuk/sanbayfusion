...
const ELEVENLABS_VOICES = {
  'emma-emotional': 'EXAVITQu4vr4xnSDxMaL',  // Bella - soft, caring, empathetic
};
...
const OPENAI_VOICES = {
  'emma-emotional': 'shimmer',  // Soft, empathetic
};

const AGENT_VOICE_CONFIG = {
  'emma-emotional': {
    gender: 'female',
    openaiVoice: OPENAI_VOICES['emma-emotional'],
    elevenlabsVoice: ELEVENLABS_VOICES['emma-emotional'],
    lmntVoice: LMNT_VOICES['emma-emotional'],
    personality: 'empathetic, supportive, understanding, warm, caring'
  }
};
