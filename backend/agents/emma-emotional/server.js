/**
 * Emma Emotional — Standalone Agent Backend
 * Port: 3418 | Provider: OpenAI gpt-4o | Fallbacks: mistral → xai
 */
...
const SLUG = 'emma-emotional';
const NAME = 'Emma Emotional';
const PROVIDER = 'openai';
const MODEL = 'gpt-4o';
const FALLBACKS = ['mistral', 'xai'];
const TEMPERATURE = 0.8;
const PORT = parseInt(process.env.PORT) || 3418;
...
app.use(cors({
  origin: process.env.CORS_ORIGIN?.split(',') || [
    'https://emma-emotional-chat.sanbayfusion.com',
