/**
 * Lazy Pawn — Standalone Agent Backend
 * Port: 3421 | Provider: OpenAI gpt-4o | Fallbacks: mistral → xai
 */
...
const SLUG = 'lazy-pawn';
const NAME = 'Lazy Pawn';
...
app.use(cors({
  origin: process.env.CORS_ORIGIN?.split(',') || [
    'https://lazy-pawn-chat.sanbayfusion.com',
