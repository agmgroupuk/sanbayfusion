...
const ELEVENLABS_VOICES = {
  'lazy-pawn': 'yoZ06aMxZJJ28mfd3POQ',  // Sam - raspy, laid-back, relaxed
};
...
const OPENAI_VOICES = {
  'lazy-pawn': 'verse',  // Laid-back, relaxed
};

const AGENT_VOICE_CONFIG = {
  'lazy-pawn': {
    gender: 'male',
    openaiVoice: OPENAI_VOICES['lazy-pawn'],
    elevenlabsVoice: ELEVENLABS_VOICES['lazy-pawn'],
    lmntVoice: LMNT_VOICES['lazy-pawn'],
    personality: 'laid-back, relaxed, humorous, unmotivated chess piece'
  }
};
