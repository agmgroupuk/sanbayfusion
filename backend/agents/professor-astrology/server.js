/**
 * Professor Astrology — Standalone Agent Backend
 * Port: 3424 | Provider: OpenAI gpt-4o | Fallbacks: mistral → xai
 */
...
const SLUG = 'professor-astrology';
const NAME = 'Professor Astrology';
const PROVIDER = 'openai';
const MODEL = 'gpt-4o';
const FALLBACKS = ['mistral', 'xai'];
const TEMPERATURE = 0.8;
const PORT = parseInt(process.env.PORT) || 3424;
...
app.use(cors({
  origin: process.env.CORS_ORIGIN?.split(',') || [
    'https://professor-astrology-chat.sanbayfusion.com',
...
app.get('/', (_req, res) => res.json({
  name: 'Agent: Professor Astrology',
  slug: SLUG,
  provider: PROVIDER,
  model: MODEL,
  status: 'running',
