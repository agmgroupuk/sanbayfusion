...
const ELEVENLABS_VOICES = {
  'professor-astrology': 'LcfcDJNUP1GQjkzn1xUU',  // Emily - calm, mystical, wise
};
...
const OPENAI_VOICES = {
  'professor-astrology': 'verse',  // Mystical, wise
};

const AGENT_VOICE_CONFIG = {
  'professor-astrology': {
    gender: 'female',
    openaiVoice: OPENAI_VOICES['professor-astrology'],
    elevenlabsVoice: ELEVENLABS_VOICES['professor-astrology'],
    lmntVoice: LMNT_VOICES['professor-astrology'],
    personality: 'mystical, wise, cosmic, intuitive, spiritual guide'
  }
};
