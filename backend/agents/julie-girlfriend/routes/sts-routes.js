...
const OPENAI_VOICES = {
  'julie-girlfriend': 'shimmer',  // Warm, romantic
};

const AGENT_VOICE_CONFIG = {
  'julie-girlfriend': {
    gender: 'female',
    openaiVoice: OPENAI_VOICES['julie-girlfriend'],
    elevenlabsVoice: ELEVENLABS_VOICES['julie-girlfriend'],
    lmntVoice: LMNT_VOICES['julie-girlfriend'],
    personality: 'romantic, caring, flirty, soft, loving girlfriend'
  }
};
