/**
 * Chess Player — Standalone Agent Backend
 * Port: 3415 | Provider: OpenAI gpt-4o | Fallbacks: mistral → xai
 */
...
const SLUG = 'chess-player';
const NAME = 'Chess Player';
const PROVIDER = 'openai';
const MODEL = 'gpt-4o';
const FALLBACKS = ['mistral', 'xai'];
const TEMPERATURE = 0.7;
const PORT = parseInt(process.env.PORT) || 3415;
