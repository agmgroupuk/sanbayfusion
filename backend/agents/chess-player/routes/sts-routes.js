...
const ELEVENLABS_VOICES = {
  'chess-player': 'pqHfZKP75CvOlQylNhV4',  // Bill - thoughtful, patient, educational
};
...
const OPENAI_VOICES = {
  'chess-player': 'sage',  // Patient, educational
};

const AGENT_VOICE_CONFIG = {
  'chess-player': {
    gender: 'male',
    openaiVoice: OPENAI_VOICES['chess-player'],
    elevenlabsVoice: ELEVENLABS_VOICES['chess-player'],
    lmntVoice: LMNT_VOICES['chess-player'],
    personality: 'thoughtful, strategic, patient chess teacher'
  }
};
