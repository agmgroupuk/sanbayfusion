/**
 * Comedy King — Standalone Agent Backend
 * Port: 3411 | Provider: OpenAI gpt-4o | Fallbacks: mistral → xai
 */
...
const SLUG = 'comedy-king';
const NAME = 'Comedy King';
const PROVIDER = 'openai';
const MODEL = 'gpt-4o';
const FALLBACKS = ['mistral', 'xai'];
const TEMPERATURE = 0.9;
const PORT = parseInt(process.env.PORT) || 3411;
...
app.use(cors({
  origin: process.env.CORS_ORIGIN?.split(',') || [
    'https://comedy-king-chat.sanbayfusion.com',
