...
const OPENAI_VOICES = {
  'comedy-king': 'alloy',  // Cheerful, witty
};

const AGENT_VOICE_CONFIG = {
  'comedy-king': {
    gender: 'male',
    openaiVoice: OPENAI_VOICES['comedy-king'],
    elevenlabsVoice: ELEVENLABS_VOICES['comedy-king'],
    lmntVoice: LMNT_VOICES['comedy-king'],
    personality: 'hilarious, witty, playful, entertaining comedian'
  }
};
