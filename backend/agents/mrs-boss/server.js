/**
 * Mrs Boss — Standalone Agent Backend
 * Port: 3422 | Provider: OpenAI gpt-4o | Fallbacks: mistral → xai
 */
...
const PORT = parseInt(process.env.PORT) || 3422;
...
app.use(cors({
  origin: process.env.CORS_ORIGIN?.split(',') || [
    'https://mrs-boss-chat.sanbayfusion.com',
