...
const OPENAI_VOICES = {
  'mrs-boss': 'sage',  // Authoritative, confident
};

const AGENT_VOICE_CONFIG = {
  'mrs-boss': {
    gender: 'female',
    openaiVoice: OPENAI_VOICES['mrs-boss'],
    elevenlabsVoice: ELEVENLABS_VOICES['mrs-boss'],
    lmntVoice: LMNT_VOICES['mrs-boss'],
    personality: 'authoritative, confident, professional, commanding leader'
  }
};
