/**
 * SMART AI ROUTER
 * Intelligent AI provider routing with:
 * - Automatic fallback on errors
 * - Capability-based routing (image generation, code, etc.)
 * - User-friendly error messages
 * - Rate limit handling
 */

// Provider capabilities — xAI primary (default), mistral + openai fallback
const PROVIDER_CAPABILITIES = {
  xai: {
    name: 'xAI',
    displayName: 'Architect',
    models: ['grok-3', 'grok-3-mini', 'grok-2-vision-1212'],
    capabilities: ['chat', 'code', 'reasoning', 'planning', 'vision', 'function-calling'],
    priority: 1,
    icon: '📐',
  },
  mistral: {
    name: 'Mistral',
    displayName: 'Maula Large',
