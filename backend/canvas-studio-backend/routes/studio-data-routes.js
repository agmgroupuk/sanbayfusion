/**
 * STUDIO DATA ROUTES — Canvas Studio
...
/**
 * Extract user from request (set by requireAuth middleware)
 */
...
// GET /api/studio-data/sessions — list user's chat sessions
...
// DELETE /api/studio-data/sessions/:id — archive a session
...
// GET /api/studio-data/memories — get user's agent memories
...
// DELETE /api/studio-data/memories/:id — delete a memory entry
...
// GET /api/studio-data/favorites — get user's favorites
...
// POST /api/studio-data/favorites — add a favorite
...
// DELETE /api/studio-data/favorites/:id — remove a favorite
...
// GET /api/studio-data/feedback — get user's submitted feedback
...
// POST /api/studio-data/feedback — submit feedback
...
// GET /api/studio-data/analytics — get user's analytics summary
router.get('/analytics', async (req, res) => {
    try {
        const userId = getUserId(req);
        if (!userId) return res.json({ analytics: null });

        // Aggregate stats from chat_analytics_interactions
...
// GET /api/studio-data/preferences — get full user preferences
...
// PUT /api/studio-data/preferences — update user preferences
