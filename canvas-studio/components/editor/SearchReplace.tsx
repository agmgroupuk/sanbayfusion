          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                placeholder="Search..."
                className="w-full pl-8 pr-3 py-1.5 bg-white/[0.04] border border-canvas-border rounded-lg text-xs text-gray-200 placeholder-gray-600 focus:border-violet-500/30 focus:ring-1 focus:ring-violet-500/20 outline-none transition-all"
              />
            </div>
            ...
            <div className="flex items-center gap-0.5 shrink-0">
              <button
                ...
                className={`p-1.5 rounded-md transition-all ${search.isCaseSensitive ? 'bg-violet-500/20 text-violet-300' : 'text-canvas-muted-deep hover:text-canvas-text hover:bg-white/[0.04]'}`}
                title="Match Case"
              >
              ...
              <button
                ...
                className={`p-1.5 rounded-md transition-all ${search.isWholeWord ? 'bg-violet-500/20 text-violet-300' : 'text-canvas-muted-deep hover:text-canvas-text hover:bg-white/[0.04]'}`}
                title="Whole Word"
              >
              ...
              <button
                ...
                className={`p-1.5 rounded-md transition-all ${search.isRegex ? 'bg-violet-500/20 text-violet-300' : 'text-canvas-muted-deep hover:text-canvas-text hover:bg-white/[0.04]'}`}
