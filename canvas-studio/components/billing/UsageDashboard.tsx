      ...
      <div className="bg-canvas-card rounded-xl border border-canvas-border p-4">
        <div className="flex items-center justify-between">
          ...
          {onUpgrade && plan !== 'enterprise' && (
            <button
              onClick={onUpgrade}
              className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-medium bg-gradient-to-r from-violet-500 to-cyan-500 text-white hover:opacity-90 transition-opacity"
            >
              Upgrade
