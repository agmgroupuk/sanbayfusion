...
const SpinVariant: React.FC<{ size: SpinnerSize }> = ({ size }) => (
  <div className={`${sizeMap[size].container} relative`}>
    ...
    <div className="absolute inset-[3px] rounded-full bg-gradient-to-br from-violet-500/5 to-cyan-500/5" />
  </div>
);
  ...
  <div className="flex items-center gap-1">
    {[0, 1, 2].map((i) => (
      <motion.div
        ...
        className={`${sizeMap[size].dot} rounded-full bg-gradient-to-r from-violet-400 to-cyan-400`}
      />
    ))}
  </div>
);
