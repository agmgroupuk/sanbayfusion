    ...
    <div className={`flex flex-col bg-canvas-card rounded-xl border border-canvas-border overflow-hidden ${className}`}>
      ...
      <div className="px-4 py-3 bg-canvas-card border-b border-canvas-border flex items-center gap-2">
        ...
        <button
          ...
          className="flex items-center gap-1 px-2.5 py-1 rounded-lg text-[11px] font-medium bg-gradient-to-r from-violet-500/20 to-cyan-500/20 text-violet-300 border border-violet-500/20 hover:border-violet-500/40 transition-colors"
        >
          ...
          >
            <div className="p-4 space-y-2">
              <div className="flex items-center gap-2">
                <div className="flex-1 flex items-center bg-white/[0.04] border border-canvas-border rounded-lg overflow-hidden focus-within:border-violet-500/30">
                  <input
                    type="text"
                    value={newDomain}
                    onChange={(e) => {
                ...
                <button
                  onClick={handleAdd}
                  disabled={!newDomain.trim() || !!validationError}
                  className="px-4 py-2 rounded-lg text-xs font-medium bg-gradient-to-r from-violet-500 to-cyan-500 text-white disabled:opacity-30 hover:opacity-90 transition-opacity"
                >
                  Add
                </button>
              </div>
