                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <button
                        ...
                        className="text-[10px] text-gray-600 hover:text-violet-400 font-mono mt-0.5 flex items-center gap-0.5"
                      >
                      ...
                      <div className="mx-4 mb-3 space-y-2">
                        ...
                        <div className="flex items-center gap-2 pt-1">
                          <button
                            ...
                            disabled={isApplying}
                            className="flex-1 py-1.5 rounded-lg text-xs font-medium bg-gradient-to-r from-violet-500 to-cyan-500 text-white disabled:opacity-50 hover:opacity-90 transition-opacity flex items-center justify-center gap-1"
                          >
                            {isApplying ? (
