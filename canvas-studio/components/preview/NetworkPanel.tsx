            ...
            {filtered.length === 0 ? (
              ...
              filtered.map((req) => (
                <motion.div
                  ...
                  className={`flex items-center px-2 py-1 text-[11px] border-b border-canvas-border cursor-pointer transition-colors ${
                ...
                >
                  ...
                  <span className={`w-16 text-right ${
                    (req.time || 0) > 1000 ? 'text-amber-400' : 'text-canvas-muted-deep'
                  }`}>
                    {formatTime(req.time)}
                  </span>
                </motion.div>
